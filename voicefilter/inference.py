...
def main(args, hp):
    ...
    target_wav, _ = librosa.load(args.target_file, sr=16000)
    ...
    sdr_after = bss_eval_sources(target_wav[:L], est_wav[:L], False)[0][0]
    print(sdr_before,sdr_after)
    os.makedirs(args.out_dir, exist_ok=True)
    out_path = os.path.join(args.out_dir, 'result2.wav')
